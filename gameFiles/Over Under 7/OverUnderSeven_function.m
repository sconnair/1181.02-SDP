function OverUnderSeven_function()
...
while(play == 'Y' && ifund>0)  
    ...
    %shift focus to command window
    commandwindow;
    prediction = input('Will the roll be under, over, or exactly on 7 (O, U, E)?: ', 's');
    ...
    close
    %fun fact
    fprintf('\nEducational Fact: The probability of rolling a 7 on two dice is 1 in 6.\n\n')
...
% if-elseif-else structure function for win\lose    
    ...
    elseif ifund ~= 0
        ...
        %fun fact
        fprintf('\nEducational Fact: Americans owe about $1.6 trillion in student loans as of June 2024 – 42 percent more than what they owed a decade earlier.\n\n')
        ...
        %fun fact
        fprintf('\nEducational Fact: As of November 18, 2024, the U.S. national debt is $35.97 trillion.\n')
        fprintf('Additionally, thanks to OSU, you are going to be in debt.\n\n')
        close
    end
